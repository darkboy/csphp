...
<?php $this->widget('demo/widget',           array('by'=>'tpl_'.($ti++)) );?>
<?php $this->widget('@m-view/demo/widget',   array('by'=>'tpl_'.($ti++)) );?>

<!-- 应用模板根目录 可以用 / 或者  @view/ 表示 -->
<?php $this->widget('/home/demo/widget',     array('by'=>'tpl_'.($ti++)) );?>
<?php $this->widget('@view/home/demo/widget',array('by'=>'tpl_'.($ti++)) );?>
