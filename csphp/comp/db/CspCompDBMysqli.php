...
class CspCompDBMysqli extends CspBaseComponent {
     ...
     *
     * @uses $CspCompDBMysqli->setQueryOption('name');
     *
    ...
    public function getOne($tableName, $columns = '*') {
        ...
        if ($res instanceof CspCompDBMysqli) {
            return $res;
     ...
     *
     * @uses $CspCompDBMysqli->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $CspCompDBMysqli->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp The name of the database field.
     * @param mixed $whereValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $CspCompDBMysqli->having('SUM(tags) > 10')
     *
     ...
     *
     * @uses $CspCompDBMysqli->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp The name of the database field.
     * @param mixed $havingValue The value of the database field.
     * @param string $operator Comparison operator. Default is =
     ...
     *
     * @uses $CspCompDBMysqli->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $CspCompDBMysqli->orderBy('id', 'desc')->orderBy('name', 'desc');
     *
     ...
     *
     * @uses $CspCompDBMysqli->groupBy('name');
     *
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert) {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof CspCompDBMysqli) {
    ...
    /**
     * Method creates new CspCompDBMysqli object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a CspCompDBMysqli subquery object
     *
     * @return CspCompDBMysqli new CspCompDBMysqli object
     */
    ...
    /**
     * Get where and what function was called for query stored in CspCompDBMysqli->trace
     *
